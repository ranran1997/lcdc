...
(function (window, document) {
	...
	Croppic = function (id, options) {
		...
		that.options = {
			...
			iconZoomMuch:"icon-zoomuch",
			iconZoom:"icon-zoom",
			iconMin:"icon-min",
			iconMinMuch:"icon-minmuch",
			iconRotateLeft:"icon-rotateleft",
			iconRotateRight:"icon-rotateright",
			iconCrop:"icon-crop"
	...
	Croppic.prototype = {
		...
		createImgUploadControls: function(){
			...
			if(that.options.customUploadButtonId ===''){ cropControlUpload = '<i class="cropControlUpload iconfont '+that.options.iconUpload+'"></i>'; }
			var cropControlRemoveCroppedImage = '<i class="cropControlRemoveCroppedImage iconfont '+that.options.iconDelete+'"></i>';
		...
		afterUpload: function(data){
            ...
            if (response.status == 'success') {
				...
				img.load(function(){
					that.initCropper();
					that.hideLoader();
					if (that.options.onAfterImgUpload) that.options.onAfterImgUpload.call(that,response.url);
				});
		...
		initialScaleImg:function(){
			...
			that.img.css({'left': -(that.imgW -that.objW)/2, 'top': -(that.imgH -that.objH)/2, 'position':'absolute'});
			if(that.options.imgEyecandy){ that.imgEyecandy.css({'left': -(that.imgW -that.objW)/2, 'top': -(that.imgH -that.objH)/2, 'position':'absolute'}); }
		...
		createCropControls: function(){
			...
			var cropControlZoomIn =          '<i class="cropControlZoomIn iconfont '+that.options.iconZoom+'"></i>';
			var cropControlZoomOut =         '<i class="cropControlZoomOut iconfont '+that.options.iconMin+'"></i>';
			var cropControlZoomMuchOut =     '';
			var cropControlRotateLeft =      '';
	        var cropControlRotateRight =     '';
	        var cropControlCrop =            '<i class="cropControlCrop iconfont '+that.options.iconCrop+'"></i>';
			var cropControlReset =           '<i class="cropControlReset iconfont '+that.options.iconDelete+'"></i>';
			
            var html;
            
			if(that.options.doubleZoomControls){
				cropControlZoomMuchIn = '<i class="cropControlZoomMuchIn iconfont '+that.options.iconZoomMuch+'"></i>';
				cropControlZoomMuchOut = '<i class="cropControlZoomMuchOut iconfont '+that.options.iconMinMuch+'"></i>';
			}
			if(that.options.rotateControls){
				cropControlRotateLeft = '<i class="cropControlRotateLeft iconfont '+that.options.iconRotateLeft+'"></i>';
				cropControlRotateRight = '<i class="cropControlRotateRight iconfont '+that.options.iconRotateRight+'"></i>';
			}
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.obj.append('<img class="croppedImg" src="'+that.options.baseUrl+ response.url + '">');
